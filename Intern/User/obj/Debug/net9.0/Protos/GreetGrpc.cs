...
namespace MyGrpcService {
  ...
  public static partial class MyService
  {
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
    static readonly grpc::Method<global::MyGrpcService.MyRequest, global::MyGrpcService.serverResponse> __Method_SendData = new grpc::Method<global::MyGrpcService.MyRequest, global::MyGrpcService.serverResponse>(
    ...
    public partial class MyServiceClient : grpc::ClientBase<MyServiceClient>
    {
      ...
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual global::MyGrpcService.serverResponse SendData(global::MyGrpcService.MyRequest request, grpc::Metadata headers = null, global::System.DateTime? deadline = null, global::System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
      {
        return SendData(request, new grpc::CallOptions(headers, deadline, cancellationToken));
      }
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual global::MyGrpcService.serverResponse SendData(global::MyGrpcService.MyRequest request, grpc::CallOptions options)
      {
        return CallInvoker.BlockingUnaryCall(__Method_SendData, null, options, request);
      }
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual grpc::AsyncUnaryCall<global::MyGrpcService.serverResponse> SendDataAsync(global::MyGrpcService.MyRequest request, grpc::Metadata headers = null, global::System.DateTime? deadline = null, global::System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
      {
        return SendDataAsync(request, new grpc::CallOptions(headers, deadline, cancellationToken));
      }
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual grpc::AsyncUnaryCall<global::MyGrpcService.serverResponse> SendDataAsync(global::MyGrpcService.MyRequest request, grpc::CallOptions options)
      {
